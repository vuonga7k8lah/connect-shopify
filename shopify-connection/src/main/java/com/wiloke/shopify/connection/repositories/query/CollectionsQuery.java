...
@Repository(value = "CollectionsQuery")
@Data
public class CollectionsQuery implements ShopifyQueryable {
    ...
    public HttpResponse<String> query() throws Exception {
        var query = this.buildHttpClient().send(this.httpRequest, HttpResponse.BodyHandlers.ofString());
